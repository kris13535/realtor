...
class Card extends React.Component{
    ...
    render(){
        const {main_image, city_name, price, description, number_of_bath, number_of_room, sqft, country, address, type, id} = this.props;
        ...
        return(
            <div className={"col-xl-3 col-lg-4 col-sm-6"}>
                {type === "loading" ?
                    ...
                    id={this.props.id} delete_apartment={this.props.delete_apartment} deleteApartmentHandelClick={this.props.deleteApartmentHandelClick} id={id}/>
                }
            </div>
        )
    }
